...
# stevejcliu.com/memcached-operator-ansible-bundle:$VERSION and stevejcliu.com/memcached-operator-ansible-catalog:$VERSION.
IMAGE_TAG_BASE ?= stevejcliu.com/memcached-operator-ansible
